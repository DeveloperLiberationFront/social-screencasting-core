...
import edu.ncsu.dlf.ScreenRecordingModule;
import edu.ncsu.dlf.externalAPI.BrowserMediaPackageUploader;
import edu.ncsu.dlf.externalAPI.RemoteToolReporter;
import edu.ncsu.dlf.localHub.database.BufferedDatabaseManager;
import edu.ncsu.dlf.localHub.database.LocalSQLDatabaseFactory;
...
import edu.ncsu.dlf.localHub.http.WebToolReportingInterface;
...
public class LocalHub implements  WebQueryInterface, WebToolReportingInterface {
	...
	/* (non-Javadoc)
	 * @see edu.ncsu.dlf.localHub.WebQueryInterface#shareClipWithUser(java.lang.String, java.lang.String, edu.ncsu.dlf.localHub.ClipOptions)
	 */
	@Override
