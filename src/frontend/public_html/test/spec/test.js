...
//    });
    ...
    beforeEach(mocks.module('socasterApp', [function(){
//    	angular.module('socasterApp').requires.push('e2e-mocks');
    }]));
    ...
    describe('Controller', function() {
      ...
      /*it('Application filter', function() {
        var $scope = scope;
        var controller = $controller('RootCtrl', { $scope: $scope});
      });*/
    });
