...
public class StorytellerHTTPHandler extends HTTPHandler {
	 ...
	 * @param server	The running StorytellerServer to get data from.
	 *
	 * @throws HTTPException	when something not good happens.
	 */
	public StorytellerHTTPHandler(HTTPRequest request, LocalHub server) throws HTTPException
	{
		super(request);
		this.server = server;
